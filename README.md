...
- [ ] All IPs are valid (not network/broadcast)
- [ ] Devices on same network have matching subnet masks
- [ ] No overlapping subnets on router interfaces
- [ ] Routing table has paths to all reachable networks
- [ ] Default route is configured (if needed)
- [ ] All connections
